...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'fp_intro': 'Enter your account details and the new password you want. The request is sent to the control panel and takes effect only after the administrator approves it.',
      ...
      'fp_account_not_found': 'No account matches this username and phone number',
    ...
    'ar_AR': {
      ...
      'fp_intro': 'أدخل بيانات حسابك وكلمة المرور الجديدة المطلوبة. يُرسل الطلب إلى لوحة التحكم ولا يُنفّذ إلا بعد موافقة المدير.',
      ...
      'fp_account_not_found': 'لا يوجد حساب مطابق لاسم المستخدم ورقم الهاتف',
