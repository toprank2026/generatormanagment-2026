...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'expenses': 'Expenses',
      'dashboard': 'Dashboard',
      // v27 item 4: collected-cash figure is titled Total Income and the
      // collected-minus-expenses figure is titled Net Profit (owner terminology).
      
      'collected_revenue': 'Total Income',
      ...
      'accountant_settlements': 'Accountant Settlements',
      'accountant_settlements_subtitle':
          'Approve or reject accountant settlement requests',
      'approve': 'Approve',
      'reject': 'Reject',
      'approve_settlement_confirm': 'Approve this settlement request?',
      'reject_settlement_confirm': 'Reject this settlement request?',
      'settlement_approved_msg': 'Settlement approved',
      'settlement_rejected_msg': 'Settlement rejected',
      ...
      // v27 new strings (M22)
      'ampere': 'Ampere',
      'board_total_amps': 'Total board amperes',
      'salary_wallet': 'Salary settlement request',
      'salary_received': 'Salary received',
      'salary_received_done': 'Salary received',
      'salary_once_per_month': 'A salary request has already been made this month',
      'request_salary_settlement': 'Request salary settlement',
      ...
      'edit_blocked_settled':
          'Cannot edit amps/type: this subscriber has a receipt included in a settlement this month.',
      ...
      'sec_subscriber': 'Subscriber name',
      'sec_month': 'Month',
      'sec_board': 'Board name',
      'sec_circuit': 'Circuit number',
      'sec_amps': 'Amperes',
      'sec_price': 'Price per ampere',
      'sec_category': 'Tariff type',
      'sec_paid': 'Amount',
      'sec_method': 'Payment method',
      'sec_discount': 'Discount',
      'sec_remaining': 'Remaining',
      'sec_accountant': 'Accountant name',
      'sec_qr': 'QR Code',
      'sec_footer': 'Footer',
      ...
      'device_limit_recover_q':
          'Move this account to this device? The other device will be unlinked and signed out.',
      'move_to_this_device': 'Move to this device',
      'unbind_current_warn':
          'This is the device you are using. Unlinking it stops syncing until the next sign-in.',
      ...
      'no_price_for_month':
          'No price set for this month — subscribers count as unpaid until you set a price',
      'report_failed': 'Could not load the report. Please try again.',
      'refunded': 'Refunded',
      ...
      // v24: LAN/Ethernet printer
      'lan_printer': 'LAN printer',
      'no_lan_printer': 'No LAN printer saved',
      'lan_printer_saved': 'Saved — used automatically for printing',
      'lan_search_hint': 'Tap to search the network for a printer',
      'lan_search': 'Search printer',
      'lan_searching': 'Searching the network…',
      'lan_forget': 'Forget printer',
      'lan_printer_found': 'Printer found',
      'lan_printer_not_found':
          'No printer found on this network — make sure it is on and connected',
      'lan_print_in_progress':
          'A print job is already in progress — please wait',
      'lan_manual': 'Enter printer IP manually',
      'lan_ip_hint': 'Printer IP (from its self-test page), port optional',
      'lan_invalid_ip': 'Invalid IP address',
      'test_print': 'Test print',
      'test_print_subtitle': 'Print a test slip on the selected printer',
      'test_print_sent': 'Test slip sent to the printer',
      'print_failed': 'Printing failed',
      'select_usb_printer': 'Select a USB printer',
      'no_usb_printer': 'No USB printer found. Connect one and try again.',
      ...
      'not_a_valid_backup': 'This file is not a valid Flash backup',
      'sync_subtitle': 'Status, pending changes & sync now',
      'generator_name': 'Generator name',
      'name': 'Name',
      'edit_account': 'Edit account',
      'edit_account_subtitle': 'Change your username, password and details',
      ...
      'confirm_identity': 'Confirm your password',
      'print_copies': 'Copies per receipt',
      ...
      'switch_wipe_warn':
          'Switching accounts will DELETE ALL local data on this device — subscribers, boards, circuits, receipts, expenses and the wallet — exactly like logout, then re-download it from the server. Continue?',
      'continue': 'Continue',
      ...
      // ---- v42 item 1/2: per-accounting-month wallet ----
      'wallet_month': 'Accounting month',
      'wallet_month_note': 'These figures belong to this month only',
      'wallet_lifetime': 'Total still in hand (all months)',
      'wallet_lifetime_note': 'The overall unsettled cash; a settlement request can never exceed it',
      // ---- v42 item 3: previous outstanding months (notice only) ----
      'prev_unpaid_title': 'Previous outstanding months',
      'prev_unpaid_body': 'This subscriber still owes earlier months. This is a notice only — it does not affect the current month account.',
      'prev_unpaid_total': 'Total outstanding',
      'prev_unpaid_months_count': 'outstanding month(s)',
      // ---- v42 item 5: subscriber month onboarding ----
      'not_yet_active': 'Added in a later month',
      'billing_starts': 'Billing starts',
      // ---- v42 item 4: forgot password (super-admin approved) ----
      'forgot_password': 'Forgot password?',
      'fp_title': 'Reset password',
      'fp_intro': 'Enter your registered phone number and the new password you want. The request is sent to the control panel and takes effect only after the administrator approves it.',
      'fp_username': 'Username',
      'fp_phone': 'Registered phone number',
      'fp_new_password': 'New password',
      'fp_confirm_password': 'Confirm new password',
      'fp_submit': 'Send request',
      'fp_passwords_mismatch': 'The two passwords do not match',
      'fp_password_too_short': 'Password must be at least 4 characters',
      'fp_account_not_found': 'No account is registered with this phone number',
      'fp_online_required': 'An internet connection is required to request a password reset',
      'fp_unavailable': 'Password reset is not available on the server yet. Please contact the administrator.',
      'fp_request_sent': 'Request sent to the control panel',
      'fp_pending_title': 'Awaiting administrator approval',
      'fp_pending_body': 'Your request has been sent. Give the administrator the verification code below. Your password will change only after they approve it.',
      'fp_verification_code': 'Verification code',
      'fp_check_status': 'Check status',
      'fp_status_pending': 'Still awaiting approval',
      'fp_status_approved': 'Approved — sign in with your new password',
      'fp_status_rejected': 'The request was rejected by the administrator',
      'fp_status_expired': 'The request expired. Please send a new one',
      'fp_back_to_login': 'Back to sign in',
      'fp_requested_at': 'Requested at',
    ...
    'ar_AR': {
      ...
      // v27 item 4: see the en_US note.
      'collected_revenue': 'الوارد الكلي',
      ...
      'settlement': 'التسوية',
      'accountant_settlements': 'تسويات المحاسبين',
      'accountant_settlements_subtitle':
          'الموافقة على طلبات تسوية المحاسبين أو رفضها',
      'approve': 'موافقة',
      'reject': 'رفض',
      'approve_settlement_confirm': 'الموافقة على طلب التسوية هذا؟',
      'reject_settlement_confirm': 'رفض طلب التسوية هذا؟',
      'settlement_approved_msg': 'تمت الموافقة على التسوية',
      'settlement_rejected_msg': 'تم رفض التسوية',
      ...
      // v27 new strings (M22)
      'ampere': 'أمبير',
      'board_total_amps': 'إجمالي أمبيرات البورد',
      'salary_wallet': 'طلب تسوية راتب',
      'salary_received': 'الراتب المستلم',
      'salary_received_done': 'تم استلام الراتب',
      'salary_once_per_month': 'تم تقديم طلب راتب لهذا الشهر بالفعل',
      'request_salary_settlement': 'طلب تسوية الراتب',
      'salary_amount': 'مبلغ الراتب',
      'net_income': 'صافي الإيرادات',
      'card_note': 'ملاحظة',
      ...
      'edit_blocked_settled':
          'لا يمكن تعديل الأمبير/الفئة: لدى المشترك وصل مشمول بتسوية لهذا الشهر.',
      ...
      'sec_subscriber': 'اسم المشترك',
      'sec_month': 'الشهر',
      'sec_board': 'اسم البورد',
      'sec_circuit': 'رقم الجوزة',
      'sec_amps': 'الأمبير',
      'sec_price': 'سعر الأمبير',
      'sec_category': 'نوع الاشتراك',
      'sec_paid': 'المبلغ',
      'sec_method': 'نوع الدفع',
      'sec_discount': 'الخصم',
      'sec_remaining': 'المتبقي',
      'sec_accountant': 'اسم المحاسب',
      'sec_qr': 'رمز QR',
      'sec_footer': 'التذييل',
      ...
      'device_limit_msg': 'هذا الحساب مرتبط بجهاز آخر بالفعل.',
      'device_limit_recover_q':
          'نقل هذا الحساب إلى هذا الجهاز؟ سيتم فصل الجهاز الآخر وتسجيل خروجه.',
      'move_to_this_device': 'نقل إلى هذا الجهاز',
      'unbind_current_warn':
          'هذا هو الجهاز الذي تستخدمه. فصله يوقف المزامنة حتى تسجيل الدخول التالي.',
      ...
      'no_price_for_month':
          'لم يُحدَّد سعر لهذا الشهر — يُحتسب المشتركون غير مدفوعين حتى تحديد السعر',
      'report_failed': 'تعذّر تحميل التقرير. حاول مرة أخرى.',
      'refunded': 'مُسترجع',
      ...
      // v24: LAN/Ethernet printer
      'lan_printer': 'طابعة الشبكة',
      'no_lan_printer': 'لا توجد طابعة شبكة محفوظة',
      'lan_printer_saved': 'محفوظة — تُستخدم تلقائياً للطباعة',
      'lan_search_hint': 'اضغط للبحث عن طابعة في الشبكة',
      'lan_search': 'البحث عن طابعة',
      'lan_searching': 'جارٍ البحث في الشبكة…',
      'lan_forget': 'نسيان الطابعة',
      'lan_printer_found': 'تم العثور على الطابعة',
      'lan_printer_not_found':
          'لم يتم العثور على طابعة في هذه الشبكة — تأكد أنها مشغّلة ومتصلة',
      'lan_print_in_progress': 'هناك مهمة طباعة قيد التنفيذ — يرجى الانتظار',
      'lan_manual': 'إدخال عنوان الطابعة يدوياً',
      'lan_ip_hint': 'عنوان IP للطابعة (من صفحة الاختبار الذاتي)، والمنفذ اختياري',
      'lan_invalid_ip': 'عنوان IP غير صالح',
      'test_print': 'طباعة تجريبية',
      'test_print_subtitle': 'اطبع قسيمة تجريبية على الطابعة المحددة',
      'test_print_sent': 'تم إرسال القسيمة التجريبية إلى الطابعة',
      'print_failed': 'فشلت الطباعة',
      'select_usb_printer': 'اختر طابعة USB',
      'no_usb_printer': 'لا توجد طابعة USB. وصّل طابعة وحاول مجددًا.',
      ...
      'not_a_valid_backup': 'هذا الملف ليس نسخة احتياطية صالحة لفلاش',
      'sync_subtitle': 'الحالة والتغييرات المعلّقة والمزامنة الآن',
      'generator_name': 'اسم المولدة',
      'name': 'الاسم',
      'edit_account': 'تعديل الحساب',
      'edit_account_subtitle': 'غيّر اسم المستخدم وكلمة المرور والتفاصيل',
      'account_updated': 'تم تحديث الحساب',
      'new_password_optional': 'كلمة مرور جديدة (اختياري)',
      'current_password': 'كلمة المرور الحالية',
      'current_password_required': 'أدخل كلمة مرورك الحالية لتغييرها',
      'confirm_identity': 'أكد كلمة مرورك',
      'print_copies': 'عدد النسخ لكل وصل',
      'up_to_date': 'محدّث',
      'update_now': 'تحديث',
      ...
      'switch_wipe_warn':
          'تبديل الحساب سيحذف كل البيانات المحلية على هذا الجهاز — المشتركين واللوحات والجوزات والإيصالات والمصاريف والمحفظة — تمامًا مثل تسجيل الخروج، ثم تُعاد تنزيلها من الخادم. هل تريد المتابعة؟',
      'continue': 'متابعة',
      ...
      // ---- v42 البند 1/2: محفظة مستقلة لكل شهر محاسبي ----
      'wallet_month': 'الشهر المحاسبي',
      'wallet_month_note': 'هذه الأرقام تخص هذا الشهر فقط',
      'wallet_lifetime': 'إجمالي المبلغ لديك (كل الأشهر)',
      'wallet_lifetime_note': 'الرصيد غير المسوّى الكلي؛ لا يمكن أن يتجاوزه أي طلب تسوية',
      // ---- v42 البند 3: الأشهر السابقة غير المسددة (تنبيه فقط) ----
      'prev_unpaid_title': 'أشهر سابقة غير مسددة',
      'prev_unpaid_body': 'لدى هذا المشترك مستحقات من أشهر سابقة. هذا تنبيه فقط ولا يؤثر على حساب الشهر الحالي.',
      'prev_unpaid_total': 'إجمالي المتبقي',
      'prev_unpaid_months_count': 'شهر غير مسدد',
      // ---- v42 البند 5: احتساب المشترك من شهر إضافته ----
      'not_yet_active': 'أُضيف في شهر لاحق',
      'billing_starts': 'يبدأ الاحتساب من',
      // ---- v42 البند 4: استعادة كلمة المرور بموافقة المدير ----
      'forgot_password': 'نسيت كلمة المرور؟',
      'fp_title': 'استعادة كلمة المرور',
      'fp_intro': 'أدخل رقم هاتفك المسجّل وكلمة المرور الجديدة المطلوبة. يُرسل الطلب إلى لوحة التحكم ولا يُنفّذ إلا بعد موافقة المدير.',
      'fp_username': 'اسم المستخدم',
      'fp_phone': 'رقم الهاتف المسجّل',
      'fp_new_password': 'كلمة المرور الجديدة',
      'fp_confirm_password': 'تأكيد كلمة المرور الجديدة',
      'fp_submit': 'إرسال الطلب',
      'fp_passwords_mismatch': 'كلمتا المرور غير متطابقتين',
      'fp_password_too_short': 'كلمة المرور يجب ألا تقل عن ٤ أحرف',
      'fp_account_not_found': 'لا يوجد حساب مسجّل بهذا الرقم',
      'fp_online_required': 'يلزم اتصال بالإنترنت لطلب استعادة كلمة المرور',
      'fp_unavailable': 'خدمة استعادة كلمة المرور غير متوفرة على الخادم بعد. يرجى مراجعة المدير.',
      'fp_request_sent': 'تم إرسال الطلب إلى لوحة التحكم',
      'fp_pending_title': 'بانتظار موافقة المدير',
      'fp_pending_body': 'تم إرسال طلبك. أعطِ المدير رمز التحقق أدناه. لن تتغير كلمة المرور إلا بعد موافقته.',
      'fp_verification_code': 'رمز التحقق',
      'fp_check_status': 'تحديث الحالة',
      'fp_status_pending': 'ما زال بانتظار الموافقة',
      'fp_status_approved': 'تمت الموافقة — سجّل الدخول بكلمة المرور الجديدة',
      'fp_status_rejected': 'تم رفض الطلب من قبل المدير',
      'fp_status_expired': 'انتهت صلاحية الطلب. الرجاء إرسال طلب جديد',
      'fp_back_to_login': 'العودة لتسجيل الدخول',
      'fp_requested_at': 'وقت الطلب',
